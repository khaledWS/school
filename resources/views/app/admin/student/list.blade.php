    ...
    <div class="card">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                ...
                <div class="modal fade" id="kt_modal_add_user" data-bs-backdrop="static" data-bs-keyboard="false"
                                    ...
                                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                                        ...
                                        <div class=" row fv-row mb-7">
                                            ...
                                            <div class="col-md-3 fv-row">
                                                ...
                                                <input class="form-control form-control-solid mt-10" type="file"
                                                    name="files[]" multiple id="">
                                                <!--end::Dropzone-->
                                            </div>
                                        </div>
                                        <!--end::Input group-->
