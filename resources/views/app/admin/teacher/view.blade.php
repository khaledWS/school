    ...
    <div class="d-flex flex-column flex-xl-row">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-center flex-column py-5">
                        ...
                        <div class="symbol symbol-100px symbol-circle mb-7">
                            <img src="{{asset('assets/media/avatars/150-1.jpg')}}" />
                        </div>
                        <!--end::Avatar-->
                        <!--begin::Name-->
        ...
        <div class="flex-lg-row-fluid ms-lg-15">
            ...
            <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8">
                ...
                <!--begin:::Tab item-->
                <li class="nav-item">
                    <a disabled class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true" data-bs-toggle="tab"
                        href="#kt_user_view_overview_security">الحساب</a>
                </li>
                <!--end:::Tab item-->
                <!--begin:::Tab item-->
                <li class="nav-item">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    ...
                    <form id="kt_modal_update_user_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                        method="POST" action="{{route('update-student',$student->id)}}">
                        @csrf
                        <!--begin::Scroll-->
                            ...
                            <div class="row g-9 mb-7">
                                ...
                                <div id="tt" class="col-md-4 fv-row">
                                    ...
                                    <select name="gender" class=" form-control form-select form-select-solid">
                                        ...
                                        <option @selected($student->gender=='male') value="male">ذكر</option>
                                        <option @selected($student->gender=='female') value="female">انثى</option>
                                    </select>
                                    <!--end::Input-->
                                </div>
                                <!--end::Col-->
                                ...
                                <div class="col-md-4 fv-row">
                                    ...
                                    <select class="form-select  form-select-solid" name="religion" id="">
                                        ...
                                        <option @selected($student->gender=='muslim') value="muslim">مسلم</option>
                                        <option @selected($student->gender=='christian') value="christian">مسيحي</option>
                                        <option @selected($student->gender=='other') value="other">غير</option>
                                    </select>
                                    <!--end::Input-->
                                </div>
                                <!--end::Col-->
