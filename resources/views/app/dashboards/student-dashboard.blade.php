...
<div id="kt_content_container" class="container-xxl">
    ...
    <div class="row gy-5 g-xl-8">
        ...
        <div class="col-xl-6">
            <div class="card card-xl-stretch">
                <!--begin::Header-->
                <div class="card-header align-items-center border-2 border-bottom border-dark ">
        ...
        <div class="col-xl-6">
            <div class="card card-xl-stretch">
                <!--begin::Header-->
                <div class="card-header align-items-center border-0  border-2 border-bottom border-dark ">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="fw-bolder mb-2 text-dark">حضور</span>
                    </h3>
                </div>
                <!--end::Header-->
                <!--begin::Body-->
    ...
    <div class="row gy-5 g-xl-8 ">
        ...
        <div class="col-xl-12">
            ...
            <div class="card">
                <!--begin::card header-->
                <div class="card-header position-relative py-0 border-bottom-2 border-dark ">
    ...
    <div class="row gy-5 g-xl-8 mt-1">
        ...
        <div class="col-xl-6">
            ...
            <div class="card h-xl-100">
                <!--begin::card-header-->
                <div class="card-header position-relative py-0 border-bottom-2 border-dark ">
                    <h3 class="card-title fw-bolder mb-2 text-dark">جدول الأمتحانات</h3>
                    <!--begin::card toolbar-->
                    <div class="card-toolbar">
                        <!--begin::nav-->
                        <ul class="nav nav-tabs nav-line-tabs d-mt-3">
        ...
        <div class="col-xl-6">
            ...
            <div class="card h-xl-100 ">
                <!--begin::card-header-->
                <div class="card-header position-relative py-0 border-bottom-2 border-dark ">
                    <h3 class="card-title fw-bolder mb-2 text-dark">نتائج الأمتحانات</h3>
                </div>
                <!--end::card-header-->
                <!--begin::card body-->
