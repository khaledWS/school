                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <a href="#" class="fw-bold text-muted text-hover-primary fs-7">$email/username</a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
                        ...
                        <div class="menu-item px-5">
                            <a href="?page=account/overview" class="menu-link px-5">صفحتي</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a href="?page=apps/projects/list" class="menu-link px-5">
                                <span class="menu-text">امتحانات</span>
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a href="/" class="menu-link px-5">تسجيل الخروج</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
